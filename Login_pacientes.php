<?php
include 'Cod_sesion_paciente.php';
 ?>
...
<html lang="en">
    ...
    <body>
       ...
       $pdo=new PDO("mysql:dbname=citas;host=127.0.0.1", "root", "");
        ...
        $Contar = $pdo->prepare("SELECT * FROM pacientes");
            $Contar->execute();
 ...
 <div class="formulario">
   <form class="" action="" method="post">
    ...
    <div class="d-flex justify-content-center" id="enlace">
        <a href="#" id="enlace" data-toggle="modal" data-target="#Registrar_Primera_Vez"> Crear cuenta</a>
    </div>
